...
To present insights using interactive dashboards and stories
...
Data Visualization – Creating charts, dashboards, and stories in Tableau
Insight Generation – Interpreting results to understand EV performance

📊 Visualizations Created
Interactive Charts
1 Dashboard
1 Story
These visualizations collectively provide a comprehensive view of electric vehicle charge behavior and range efficiency.

🛠️ Tools & Technologies Used
Tableau – Data visualization and dashboard creation
Microsoft Excel / CSV – Data handling and preprocessing

📈 Key Insights
Relationship between battery charge level and driving range
Variation in energy consumption across vehicles
Charging efficiency patterns
Identification of optimal range usage trends
